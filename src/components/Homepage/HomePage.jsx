		...
		<>
			...
			<>
				...
				<div className="img-container">
					<img src={Business} alt="business picture for homepage" />
				</div>
				<section className="testimonial-section">
					<p>
						"Lorem ipsum, dolor sit amet consectetur adipisicing
						elit. Illo neque pariatur dolorem dolor fuga temporibus,
						ipsum, beatae incidunt architecto, esse voluptatem ab!
						Minus, sapiente asperiores eius quas veritatis expedita
						nam."
					</p>
					<span>- Sophie</span>
				</section>
					...
					<section className="services-container">
						...
						<article className="main-card">
							<header>
								<img
									className="card-img"
									src="https://source.unsplash.com/400x300?work"
									alt=""
								/>
							</header>
							<h2 className="card-title">Relation</h2>
