...
function QuickView(props) {
    ...
    useEffect(() => {
        async function fetchQuickView() {
            ...
            try {
                const response = await axios.get(`https://feedeleetee-back.vercel.app/quickview`, { headers });
                    ...
                    <div className="quickview__body">
                        <div className="quickview__body--left">
                            ...
                            {quickView.number_of_clients > 0 ? (
                                ...
                                <p className="no-clients"> vous n'avez pas encore de clients</p>
                            )}
                        </div>
                        <div className="quickview__body--right">
                            <div className="quickview__card quickview__card--summary">
                                {props.enterprise.logo && <img className=" card__logo" src={`data:image/png;base64,${props.enterprise.logo}`} alt="logo" />}
